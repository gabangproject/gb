...
$(function(){
	$('#checkBtn').click(function(){
		...
		$.ajax({
			type:'post',
			url:'../main/phone_ok.do', // 값 보내기
			data:{"phone":phone}, // 어떤값을 보낼건지
			/* async:false, */
...
function ok()
{
	parent.frm.phone.value=$('#phone').val();
...
<body>
	<div class="container">
		<div class="row">
			<table class="table">
			<tr>
				<td>전화번호:<input type=text size=14 id=phone>
