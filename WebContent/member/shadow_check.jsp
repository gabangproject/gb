...
$(function(){
	...
	$('#checkBtn').click(function(){
		...
		$.ajax({
			type:'post',
			url:'../main/check_ok.do', // 값 보내기
			data:{"param":param}, // 어떤값을 보낼건지
			/* async:false, */
...
function ok()
{
	parent.frm.compTel.value=$('#param').val();
...
<body>
	...
	<div class="container">
		<div class="row">
			<table class="table">
			<tr>
				<td>중개사 전화번호:<input type=text size=10 id=param>
