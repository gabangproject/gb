...
$(function(){
	$('#checkBtn').click(function(){
		...
		$.ajax({
			type:'post',
			url:'../main/license_ok.do', // 값 보내기
			data:{"license":license}, // 어떤값을 보낼건지
			/* async:false, */
...
<body>
	<div class="container">
		<div class="row">
			<table class="table">
			<tr>
				<td>중개사 자격번호:<input type=text size=14 id=license>
