				...
				<form id="maemul_upload" class="form-horizontal" enctype="multipart/form-data" action="../main/upload.do">
					...
					<fieldset form="maemul_upload">
						...
						<div class="form-group">
								...
								<div class="col-md-4">
								<input type="text" id="postcode" class="form-control" placeholder="우편번호" readonly onclick="searchPostcode()">
								
								<input type="text" id="address" class="form-control" placeholder="주소" onclick="searchPostcode()"
