...
public class BoardModel {
	...
	/*
	 * @RequestMapping("qnaboard/content.do") public String
	 * boardContentData(HttpServletRequest request) { String
	 * no=request.getParameter("no"); //DB연동 BoardVO vo =
	 * BoardDAO.boardContentData(Integer.parseInt(no)); request.setAttribute("vo",
	 * vo); return "content.jsp"; }
	 */
