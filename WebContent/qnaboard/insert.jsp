       ...
       -->
								<form method=post action="insert_ok.do">
									<table class="table table-hover">
										<tr>
											<td width="15%" height="10%" class="text-right" style="background-color:#FAF4C0; color:#000000;">제목</td>
											<td width="85%" height="10%" class="text-left"><input type=text name=title size=45 required></td>
										</tr>

										<tr>
											<td width="15%" height="500px" class="success text-right" style="background-color:#FAF4C0; color:#000000;">내용</td>
